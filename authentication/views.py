    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            if User.objects.filter(email=email).exists():
                ...
                dt = PreRegistration(first_name=form.cleaned_data['first_name'], last_name=form.cleaned_data['last_name'], username=form.cleaned_data[
                                     'username'], email=email, otp=otp, password1=form.cleaned_data['password1'], password2=form.cleaned_data['password2'])
                dt.save()
                # form.save()
